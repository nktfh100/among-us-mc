...
public class TaskRefuelInv extends TaskInvHolder {

	private static ArrayList<ArrayList<Integer>> slots = new ArrayList<ArrayList<Integer>>();

	static {
		slots.add(new ArrayList<Integer>(Arrays.asList(37, 38, 39, 40)));
		slots.add(new ArrayList<Integer>(Arrays.asList(28, 29, 30, 31)));
		slots.add(new ArrayList<Integer>(Arrays.asList(19, 20, 21, 22)));
		slots.add(new ArrayList<Integer>(Arrays.asList(10, 11, 12, 13)));
	}
